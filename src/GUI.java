...
public class GUI extends JFrame {
    ...
    private void setupSearchButton() {
        btnSearch.addActionListener(e -> handleSearchAction());
    }
                private void handleSearchAction() {
                    ...
                    if (!btn15.isSelected() && !btn30.isSelected()) {
                        JOptionPane.showMessageDialog(this, "Please select pay coverage (15th or 30th)");
                        return;
                    }
                    try {
                        ...
                        JOptionPane.showMessageDialog("Invalid employee number. Please enter digits only.");
                    } catch (Exception ex) {
        ...
        private void handleRowSelection(){
            ...
            boolean rowSelected = selectedRow != -1;
                    btnUpdate.setEnabled(rowSelected != -1);
                    btnDelete.setEnabled(rowSelected != -1);
        ...
        private void setupUpdateButton() {
            btnUpdate.addActionListener(e -> {
                ...
                if (employee != null) {
                    ...
                    if (success) {
                        JOptionPane.showMessageDialog("Employee updated successfully!");
                        refreshEmployeeTable();
                    } else {
                        JOptionPane.showMessageDialog("Failed to update employee. Please try again.", "Error");
                    }
                }
            });
        }
        ...
        private void setupDeleteButton() {
            btnDelete.addActionListener(e -> {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    ...
                    if (success) {
                        JOptionPane.showMessageDialog("Employee deketed.");
                        refreshEmployeeTable();
                        clearEditFields();
                    } else {
                        JOptionPane.showMessageDialog("Failed to delete employee.", "Error");
                    }
                }
            });
        }
